    ...
    <div>
      <div className="h-[400px] w-full mt-[50px] flex items-center justify-center">
        <div className="flex flex-col h-fit gap-[30px] w-[90%] ">
          <span className="text-white font-thin font-serif text-[24px] xs:text-[32px] md:text-[48px]">
            Student Management for Schools
          </span>

          <span className="text-white  font-serif text-[16px] xs:text-[20px] md:text-[24px]">
